...
/**
 * This class creates a new <code>Graphic</code> object.
 * It contains the information about the graphic, including the type of
 * shape, the (x,y) positions of the top-left and bottom-right corners
 * of the graphic, whether the graphic is solid or an outline, as well as
 * the colour of the shape, the colour of the cyclic shading, and the
 * duration it is displayed on the screen for.
 * 
 * @version 2.0
 * @author  EyeHouse Ltd.
 */
public class Graphic {
	...
	/**
	 * Returns the horizontal position of the bottom-right corner of the graphic.
	 * @return Position of the top-left corner
	 */
	 ...
	 * @param solid True/False condition
	 */
	 ...
	 * @param graphiccolor Graphic colour (8-digit hex)
	 */
	...
	/**
	 * Sets the colour of the graphic.
	 * @param shadingcolor Graphic's shading colour (8-digit hex)
	 */
