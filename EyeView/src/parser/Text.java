...
/**
 * This class creates a new <code>Text</code> object.
 * It contains the source of the text which may be sourced from a text file
 * or from within in the XML, the (x,y) position of the top-left corner of the
 * text box, the font of the text, as well as the font colour and size, and 
 * the duration it is displayed on the screen for.
 * 
 * @version 2.0
 * @author  EyeHouse Ltd.
 */
public class Text {
	 ...
	 * @param sourcefile The rich text content
	 */
	...
	/**
	 * Sets the font size for the text. (default from <code>DefaultSettings</code>)
	...
	/**
	 * Returns the font size for the text. (default from <code>DefaultSettings</code>)
	...
	/**
	 * Sets the font colour for the text. (default from <code>DefaultSettings</code>)
	 * @param fontcolor Font colour (8-digit hex)
	 */
	...
	/**
	 * Returns the font colour for the text. (default from <code>DefaultSettings</code>)
