...
public class ImageData {
	...
	/**
	 * Sets the time delay after which the image is first displayed on the
	 * slide. (default 0)
	 * 
	 * @param starttime
	 *            Time in seconds
	...
	/**
	 * Returns the time delay after which the image is first displayed on the
	 * slide. (default 0)
	 * 
