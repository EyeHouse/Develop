...
/**
 * This class creates a new object of type <code>DocumentInfo</code>.
 * It contains the information about the slideshow, including the author,
 * version, the group ID, and a brief comment about the document's content.
 *  
 * @version 2.0
 * @author  EyeHouse Ltd.
 */
public class DocumentInfo {
	 ...
	 * @param version Version of slideshow document
	 */
	 ...
	 * @param comment Slideshow description
	 */
	 ...
	 * @param groupid Slideshow's group ID
	 */
