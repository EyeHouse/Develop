...
public class TextElement {
	 ...
	 *            Font of text
	 * @param timeout
	 *            Time (seconds) for which the text should be displayed. 0 will
	...
	public void display(StackPane pane) {
		...
		StackPane.setMargin(label, new Insets(pane.getHeight() * ypos, 0, 0,
				pane.getWidth() * xpos));
	 ...
	 * 
	 * @param xpos
	 *            X position in proportion of pixels from left of the pane.
	 */
	 ...
	 * 
	 * @param ypos
	 *            Y position in proportion of pixels from top of the pane.
	 */
	 ...
	 * 
	 * @param xpos
	 *            x position in proportion of pixels from top of the pane.
	 * 
	 * @param ypos
	 *            y position in pixels from top of the pane.
	 */
	 ...
	 * 
	 * @param timeout
	 *            Time in seconds for the text to be visible.
	 */
