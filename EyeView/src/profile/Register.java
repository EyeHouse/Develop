...
public class Register extends Window {
	...
	private RadioButton buttonLandlord = new RadioButton(
			Translator.translateText(languageIndex, "Landlord"));
	private BadWordCheck bwc;
	...
	public Register() {
		...
		Label requiredField = new Label(Translator.translateText(languageIndex,
				"*Required field."));
	...
	public void setupTextFields(GridPane grid) {
		...
		Label chooseNameLabel = new Label(Translator.translateText(
				languageIndex, "*Choose a username:"));
		...
		Label nameLabel = new Label(Translator.translateText(languageIndex,
				"*First name:"));
		...
		Label lastNameLabel = new Label(Translator.translateText(languageIndex,
				"*Last name:"));
		...
		Label birthLabel = new Label(Translator.translateText(languageIndex,
				"*Date of Birth:"));
		...
		Label accountLabel = new Label(Translator.translateText(languageIndex,
				"*Account Type:"));
		...
		Label emailLabel = new Label(Translator.translateText(languageIndex,
				"*Email:"));
		...
		Label skypeLabel = new Label(Translator.translateText(languageIndex,
				"Skype Username:"));
		...
		skypeID.textProperty().addListener(new ChangeListener<String>() {
			@Override
			public void changed(
					final ObservableValue<? extends String> observable,
					String oldValue, String newValue) {
			...
			// information is correct
				...
				if (DataHandler.isValidEmailAddress(email.getText()) == false) {
					...
					if (DataHandler.passwordChecker(password.getText(),
						...
						System.out.println(Translator.translateText(
								languageIndex, "Password check failed"));
						createWarningPopup(Translator.translateText(
								languageIndex, "Incorrect Password. Try Again"));
						dialogStage.show();
					} else {
